...
module "app_gatway" {
  source             = "../../child_module/k_app_getway"
  application_gatway = var.application_gatway
  depends_on = [ module.subnet, module.network_sequrity_group, module.virtual_network ]
}
